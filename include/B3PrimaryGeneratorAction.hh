...
class B3PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    ...
    // The following is the definition of the function GetParticleGun(). This
    // function return the name of the current implementation of the
    // G4VPrimaryGeneratorAction. In this case it returns the pointer
    // to G4ParticleGun
